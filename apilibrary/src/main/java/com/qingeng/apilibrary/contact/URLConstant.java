...
public class URLConstant {
    ...
    public static final String URL_BASE = "http://testadmin.feijiejieguanjia.com";
//    public static final String URL_BASE = "http://wangly111.natapp1.cc";
    ...
    public static final String LOGIN_USER_INFO = "/app/user/userInfo";
    ...
    public static final String GET_OTHER_USER_INFO = "/app/user/getUserInfo";

    public static final String CREATE_TEAM = "/app/wahuhighgroup/createTeam";

    public static final String QUERY_MY_FRIENDS = "/app/user/addressBook";
    ...
    public static final String ADD_FAVORITE_MSG = "/app/wafavoritemsg/addFavoriteMsg";
    ...
    public static final String GET_ONE_THEME = "/app/watheme/getOneTheme";
    ...
    public static final String URL_SEND_CODE = "/api/sendSms";
    public static final String URL_REGISTER_PHONE = "/api/registerPhone";
    public static final String URL_LOGIN_PHONE = "/api/login";
    public static final String URL_LOGIN_CODE = "/api/phoneCodeLogin";
    public static final String URL_QQ_APP_LOGIN = "/api/qqappLogin";
    public static final String URL_WX_APP_LOGIN = "/api/wxappLogin";
    public static final String URL_ALI_PAY_APP_AUTH = "/api/alipayAppAuth";
    public static final String URL_ALI_PAY_LOGIN = "/api/alipayLogin";

    public static final String URL_RESET_PASSWORD = "/api/forgetPassword";
    public static final String URL_GET_USER_INFO = "/api/getInfo";
    public static final String URL_UPDATE_WYIMTOKEN = "/api/updateWYIMToken";
    public static final String URL_BIND_PHONE = "/api/user/bindPhone";

    public static final String URL_UPDATE_PHONE = "/api/updatePhone";
    public static final String URL_VERIFY_CODE = "/api/verifyCode";


    public static final String URL_LOOK_SYSTEM_NOTICE = "/api/doctor/lookSystemNotice";
    public static final String URL_GET_PROPEDUCATION_LIST = "/api/doctor/getPropEducationList";
    public static final String URL_ADD_PROPEDUCATION = "/api/doctor/addNewPropEduction";
    public static final String URL_GET_DOCTOR_INFO = "/api/doctor/getDoctorInfo";
    public static final String URL_UPDATE_USERINFO = "/api/updateUserInfo";
    public static final String URL_DOCTOR_SET_SELF_ORDER_TIME = "/api/consultation/doctorSetSelfOrderTime";
    public static final String URL_GET_VISIT_ORDER_TIME = "/api/consultation/getVisitOrderTime";
    public static final String URL_GET_UPLOAD_URL = "/api/doctor/getUploadUrl";
    public static final String URL_FIND_REVIEW_LIST = "/api/doctor/findReviewList";
    public static final String URL_FIND_ORDERS_DOCTOR = "/api/doctor/findOrdersDoctor";
    public static final String URL_SELECT_USER_BANK_LIST = "/api/doctor/selectUserBankList";
    public static final String URL_ADD_BANK_CARD = "/api/doctor/addBankCard";
    public static final String URL_DELETE_BANK_CARD = "/api/doctor/delBankCard";
    public static final String URL_USER_WITHDRAWAL = "/api/doctor/userWithdrawal";
    public static final String URL_SELECT_SURVEY_MODEL_LIST = "/api/doctor/selectSurveyModelList";
    public static final String URL_SELECT_SUBJECT_BY_MODEL_ID = "/api/doctor/selectSubjectByModelId";
    public static final String URL_LOOK_SURVEY_SUBJECT_DETIL_BY_ID = "/api/doctor/lookSurveySubjectDetilById";
    public static final String URL_UPDATE_SURVEY_SUBJECT = "/api/doctor/updateSurveySubject";
