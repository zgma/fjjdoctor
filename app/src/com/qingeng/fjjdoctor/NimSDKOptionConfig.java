...
import com.qingeng.fjjdoctor.main.activity.WelcomeActivity;
...
class NimSDKOptionConfig {
    ...
    private static StatusBarNotificationConfig loadStatusBarNotificationConfig() {
        ...
        // 通知铃声的uri字符串
        config.notificationSound = "android.resource://com.qingeng.fjjdoctor/raw/msg";
    ...
    private static MixPushConfig buildMixPushConfig() {
        ...
        // 小米推送
        config.xmAppId = "2882303761518596160";
        config.xmAppKey = "5951859625160";
        config.xmCertificateName = "XM_PUSH";

        // 华为推送
        config.hwCertificateName = "HUAWEI_PUSH";
...
//        config.fcmCertificateName = "DEMO_FCM_PUSH";
        ...
        // oppo推送
        config.oppoAppId = "30342825";
        config.oppoAppKey = "7f72f5c4195340539ffb3491f5db3b5b";
        config.oppoAppSercet = "a25a1c7aa54e485286035697a5a22d65";
