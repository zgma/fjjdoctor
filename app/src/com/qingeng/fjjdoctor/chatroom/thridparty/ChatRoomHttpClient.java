package com.qingeng.fjjdoctor.chatroom.thridparty;
...
import com.qingeng.fjjdoctor.DemoPrivatizationConfig;
import com.qingeng.fjjdoctor.chatroom.helper.ExtensionHelper;
import com.qingeng.fjjdoctor.config.DemoServers;
                ...
                if (resCode == RESULT_CODE_SUCCESS) {
                    ...
                    if (msg != null) {
                        ...
                        for (int i = 0; i < rooms.size(); i++) {
                            ...
                            roomInfo.setExtension(ExtensionHelper.getMapFromJsonString(
