...
package com.qingeng.fjjdoctor.common.ui.viewpager;
...
import com.qingeng.fjjdoctor.main.reminder.ReminderSettings;
...
public class PagerSlidingTabStrip extends HorizontalScrollView implements OnPageChangeListener {
    ...
    private SlidingTabPagerAdapter pagerAdapter;
    ...
    public void setViewPager(ViewPager pager) {
        ...
        pagerAdapter = (SlidingTabPagerAdapter) pager.getAdapter();
    ...
    private void setChooseTabViewTextColor(int position) {
        ...
        for (int i = 0; i < childCount; ++i) {
            ...
            iconView = (ImageView) tabView.findViewById(R.id.tab_title_icon);
            if (i == position) {
                textView.setTextColor(getResources().getColor(checkedTextColor));
                if (iconView != null && pagerAdapter.getPageTitleData(i) instanceof MainTab) {
                    MainTab mainTab  = pagerAdapter.getPageTitleData(i);
                    iconView.setImageResource(mainTab.checkedIcon);
                }
            } else {
                textView.setTextColor(getResources().getColor(unCheckedTextColor));
                if (iconView != null && pagerAdapter.getPageTitleData(i) instanceof MainTab) {
                    MainTab mainTab  = pagerAdapter.getPageTitleData(i);
                    iconView.setImageResource(mainTab.unCheckedIcon);
                }
            }
        }
    }
    ...
    private void addTabView(final int position, String title) {
        ...
        ImageView titleIV = ((ImageView) tabView.findViewById(R.id.tab_title_icon));
        ...
        if (titleIV != null && pagerAdapter.getPageTitleData(position) instanceof MainTab) {
            MainTab mainTab  = pagerAdapter.getPageTitleData(position);
            titleIV.setImageResource(mainTab.unCheckedIcon);
        }
