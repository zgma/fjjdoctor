...
import com.qingeng.fjjdoctor.contact.helper.UserUpdateHelper;
...
public class UserProfileEditItemActivity extends UI implements View.OnClickListener {
    ...
    public static final void startActivity(Context context, int key, String data) {
        ...
        intent.putExtra(EXTRA_DATA2, data);
        ((Activity) context).startActivityForResult(intent, REQUEST_CODE);
    }
    public static final void startActivity(Context context, int key, String data, String data2) {
        Intent intent = new Intent();
        intent.setClass(context, UserProfileEditItemActivity.class);
        intent.putExtra(EXTRA_KEY, key);
        intent.putExtra(EXTRA_DATA, data);
    ...
    private void parseIntent() {
        ...
        data2 = getIntent().getStringExtra(EXTRA_DATA2);
    }
...
/*            Map<FriendFieldEnum, Object> map = new HashMap<>();
            ...
            HttpClient.updateAlias(Integer.parseInt(data2), content.toString(), new HttpInterface() {
                @Override
                ...
                public void onFailure(int requestCode, String message) {
                    ToastHelper.showToast(UserProfileEditItemActivity.this, message);
                }
            ...
            }, RequestCommandCode.UPDATE_ALIAS);
