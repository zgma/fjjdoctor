...
import com.qingeng.fjjdoctor.location.adapter.IconListAdapter;
import com.qingeng.fjjdoctor.location.adapter.IconListAdapter.IconListItem;
import com.qingeng.fjjdoctor.location.helper.MapHelper;
...
import com.qingeng.fjjdoctor.util.NavigationUtils;
...
public class NavigationAmapActivity extends UI implements
    ...
    private void initView() {
        ...
        iv_navigation = findView(R.id.iv_navigation);
...
//            setTitle(R.string.location_map);
            setTitle(desAddressInfo);
            tv_address.setText(desAddressInfo);
            sendButton.setVisibility(View.GONE);
        }
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.iv_navigation:
                navigation(desLatLng.latitude,desLatLng.longitude,desAddressInfo);
                break;
        }
    }
    ...
    private void navigation(Double latitude, Double longitude, String address) {
        new AlertView("跳转导航", null, "取消", null,
                new String[]{"百度地图", "高德地图"},
                this, AlertView.Style.ActionSheet, new OnItemClickListener() {
            public void onItemClick(Object o, int position2) {
                if (position2 == 0) {
                    NavigationUtils.invokingBD(NavigationAmapActivity.this, latitude, longitude);
                }
                if (position2 == 1) {
                    NavigationUtils.invokingGD(NavigationAmapActivity.this, latitude, longitude, address);
                }
            }
