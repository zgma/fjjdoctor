...
//            items.add(new SettingTemplate(TAG_NRTC_SETTINGS, getString(R.string.nrtc_settings))); 音视频注释
            items.add(SettingTemplate.addLine());
...
//                AVChatKit.startAVChatSettings(SettingsActivity.this); 音视频注释
                break;
