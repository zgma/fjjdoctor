...
import com.qingeng.fjjdoctor.session.WatchMultiRetweetActivity;
...
public class MsgViewHolderMultiRetweet extends MsgViewHolderBase {
    ...
    public void onItemClick() {
        if (context instanceof WatchMultiRetweetActivity) {
            ...
            WatchMultiRetweetActivity.startForResult(MessageListPanelEx.REQUEST_CODE_FORWARD_MULTI_RETWEET, (Activity) context, message);
        }
    }
}
