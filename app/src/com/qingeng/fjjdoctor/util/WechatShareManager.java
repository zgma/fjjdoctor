...
public class WechatShareManager {
    ...
    private void initWechatShare(Context context) {
        if (mWXApi == null) {
            mWXApi = WXAPIFactory.createWXAPI(context, MainConstant.WX_APP_ID, true);
        }
        mWXApi.registerApp(MainConstant.WX_APP_ID);
    }
    ...
    private void shareWebPage(ShareContent shareContent, int shareType) {
        ...
        if (thumb == null) {
            ...
            msg.thumbData = Util.bmpToByteArray(thumb, 30);
        }
...
//        Bitmap thumb = BitmapFactory.decodeResource(mContext.getResources(), R.drawable.send_music_thumb);
        Bitmap thumb = BitmapFactory.decodeResource(mContext.getResources(), 1);
