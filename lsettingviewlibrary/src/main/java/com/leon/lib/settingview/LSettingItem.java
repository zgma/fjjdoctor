...
public class LSettingItem extends RelativeLayout {
    ...
    private OnLSettingItemViewClick mOnLSettingItemViewClick;
    ...
    public LSettingItem(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mRightIcon_check.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (mOnLSettingItemClick != null) {
                    mOnLSettingItemClick.click(getId(), isChecked);
                }
            }
        });
        ...
        mIvLeftIcon.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mOnLSettingItemViewClick != null) {
                    mOnLSettingItemViewClick.onLeftIconClick(getId());
                }
            }
        });
        mTvRightText.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (mOnLSettingItemViewClick != null) {
                    mOnLSettingItemViewClick.onRightTextClick(getId());
                } else {
                    clickOn();
                }
            }
    ...
    public void setmOnLSettingItemViewClick(OnLSettingItemViewClick mOnLSettingItemViewClick) {
        this.mOnLSettingItemViewClick = mOnLSettingItemViewClick;
    }
        ...
        switch (mRightStyle) {
            ...
            case 1:
                if (null != mOnLSettingItemClick) {
                    mOnLSettingItemClick.click(getId(), mChecked);
                }
                break;
            case 2:
                //选择框切换选中状态
    ...
    public interface OnLSettingItemViewClick {
