...
//    private static final int MAX_FRAME_HEIGHT = 675; // = 5/8 * 1080
    ...
    private static int findDesiredDimensionInRange(int resolution, int hardMin, int hardMax) {
        ...
        int dim = 3 * resolution / 5; // Target 3/4 of each dimension
        if (dim < hardMin) {
            return hardMin;
        }
        if (dim > hardMax) {
    ...
    public synchronized Rect getFramingRect() {
        if (framingRect == null) {
            ...
            System.out.println("screenResolution.y-"+screenResolution.y);
            System.out.println("leftOffset-"+leftOffset);
            System.out.println("topOffset-"+topOffset);
            System.out.println("leftOffset + width-"+leftOffset + width);
            System.out.println("topOffset + height-"+topOffset + height);
