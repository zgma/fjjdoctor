 ...
 */
public class ContactSelectToSendMessageActivity extends UI implements View.OnClickListener, SearchView.OnQueryTextListener {
    ...
    public static class Option implements Serializable {
         ...
         * 允许不选任何人点击确定
         */
        public boolean allowSelectEmpty = true;
    ...
    public static void start(Context context, Option option) {
        ...
        intent.setClass(context, ContactSelectToSendMessageActivity.class);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.nim_contacts_select2);

        ToolBarOptions options = new NimToolBarOptions();
        options.titleString= "选择收信人";
        ...
        toolbarView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (contactAdapter.getSelectedItem()== null || contactAdapter.getSelectedItem().isEmpty()){
                    ToastHelper.showToast(ContactSelectToSendMessageActivity.this, "请选择接收人");
                    return;
                }
                ArrayList<String> strings = new ArrayList<>();
                ArrayList<String> names = new ArrayList<>();
                for (int i = 0; i <contactAdapter.getSelectedItem().size() ; i++) {
                    strings.add(contactAdapter.getSelectedItem().get(i).getContact().getContactId());
                    names.add(contactAdapter.getSelectedItem().get(i).getContact().getDisplayName());
                }


                SendManyMessageActivity.start(ContactSelectToSendMessageActivity.this, strings,names);
            }
        });
    ...
    private void initAdapter() {
        ...
        // contact adapter
        contactAdapter = new ContactSelectAdapter(ContactSelectToSendMessageActivity.this, new ContactsSelectGroupStrategy(),
                dataProvider) {
                ...
                if (option.multi) {
                    ...
                    if (contactAdapter.isSelected(position)) {
                        ...
                        if (contactSelectedAdapter.getCount() <= option.maxSelectNum) {
                            ...
                            ToastHelper.showToast(ContactSelectToSendMessageActivity.this, option.maxSelectedTip);
                        }
...
//        return sb.toString();
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btnSelect) {
           /* List<IContact> contacts = contactSelectedAdapter
            ...
            contactSelectedAdapter.reset();
            for (int i = 0; i <contactAdapter.getSelectedItem().size() ; i++) {
                contactSelectedAdapter.addContact(contactAdapter.getSelectedItem().get(i).getContact());
            }
            arrangeSelected();
        }
    }
    ...
    private void textChange(String query){
        queryText = query;
     ...
     * @return
     */
    public static Option getCreateContactSelectOption() {
        // 限制群成员数量在群容量范围内
    ...
    private TextWatcher watcherInput = new TextWatcher() {
        ...
        public void afterTextChanged(Editable s) {
            if (s != null && s.length() > 0) {
                ...
                textChange(input.getText().toString().trim());
