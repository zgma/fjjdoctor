 ...
 */
public abstract class BaseMessageActivity_Many extends UI {

    protected String sessionId;

    private SessionCustomization customization;

    private MessageFragment_Many messageFragment;

    private SensorManager sensorManager;

    private Sensor proximitySensor;

    protected abstract MessageFragment_Many fragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        messageFragment = (MessageFragment_Many) switchContent(fragment());
        if (enableSensor()) {
            initSensor();
        }
    }
        ...
        for (final SessionCustomization.OptionsButton button : buttons) {
            ...
            imageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    button.onClick(BaseMessageActivity_Many.this, v, sessionId);
                }
            });
    ...
    private SensorEventListener sensorEventListener = new SensorEventListener() {
        ...
        public void onSensorChanged(SensorEvent event) {
            ...
            if (0.0f == dis[0]) {
                //靠近，设置为听筒模式
                MessageAudioControl.getInstance(BaseMessageActivity_Many.this).setEarPhoneModeEnable(true);
            } else {
                //离开，复原
                MessageAudioControl.getInstance(BaseMessageActivity_Many.this).setEarPhoneModeEnable(UserPreferences.isEarPhoneModeEnable());
            }
        }
