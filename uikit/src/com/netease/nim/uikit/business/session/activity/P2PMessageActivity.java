...
public class P2PMessageActivity extends BaseMessageActivity {
    ...
    private void getSetting(){
        HttpClient.queryTopOrNotice(sessionId, 2, new HttpInterface() {
            @Override
            public void onSuccess(int requestCode, BaseResponseData baseResponseData) {
                ...
                fragment.setScreenNotify(targetScreenNotify == 1);
                fragment.setMyUserName(UserInfoHelper.getUserName(AppPreferences.getAccId()));
            }
        ...
        }, RequestCommandCode.QUERY_TOP_OR_NOTICE);

        HttpClient.userInfoByAccId(sessionId, new HttpInterface() {
            @Override
            public void onSuccess(int requestCode, BaseResponseData baseResponseData) {
                TargetUserBean  targetUserBean = JSON.parseObject(JSON.toJSONString(baseResponseData.getData()), TargetUserBean.class);
                setTitle(TextUtils.isEmpty(targetUserBean.getAlias())?targetUserBean.getTargetUsername():targetUserBean.getAlias());
