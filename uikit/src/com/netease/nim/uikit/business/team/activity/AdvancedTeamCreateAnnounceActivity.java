...
*/
        ...
        baseRequestBean.addParams("announcement", teamAnnounceContent.getText().toString());
        ...
        HttpClient.updateGroupInfo(baseRequestBean, new HttpInterface() {
            ...
            public void onFailure(int requestCode, String message) {
                ToastHelper.showToast(AdvancedTeamCreateAnnounceActivity.this, message);
            }
        ...
        }, RequestCommandCode.UPDATE_GROUP_INFO_ANNOUNCEMENT);
