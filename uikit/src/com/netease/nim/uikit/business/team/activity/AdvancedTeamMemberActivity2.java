 ...
 */
public class AdvancedTeamMemberActivity2 extends UI implements TAdapterDelegate,
    ...
    public static void startActivityForResult(Activity context, String tid, int resCode) {
        ...
        intent.setClass(context, AdvancedTeamMemberActivity2.class);
        ...
        EasyAlertDialog dialog = EasyAlertDialogHelper.createOkCancelDiolag(this, "提示",
                ...
                new EasyAlertDialogHelper.OnDialogActionListener() {
                    ...
                    public void doOkAction() {
                        ...
                        HttpClient.kickUser(waHuHighGroup.getId()+"",account,AdvancedTeamMemberActivity2.this,RequestCommandCode.KICK_USER);
                    }
                });
        dialog.show();
    }
    ...
    public void onHeadImageViewClick(String account) {
        AdvancedTeamMemberInfoActivity.startActivityForResult(AdvancedTeamMemberActivity2.this, account, teamId);
    }
