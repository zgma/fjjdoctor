...
public abstract class UI extends AppCompatActivity {
    ...
    public void setToolBar(int toolBarId, ToolBarOptions options) {
        ...
        if (options.titleColor != 0){
            toolbar.setTitleTextColor(UiUtils.getColor(this, options.titleColor));
        }
        if (options.backgrounpColor != 0){
            toolbar.setBackgroundColor(UiUtils.getColor(this, options.backgrounpColor));
        }else {
            toolbar.setBackgroundColor(UiUtils.getColor(this, R.color.common_bg));
        }
    ...
    public Resources getResources() {
        ...
        if (Build.VERSION.SDK_INT <= Build.VERSION_CODES.N) {
            ...
            config.fontScale= 1+AppPreferences.getTextSizeSetting()*0.1f;//1 设置正常字体大小的倍数
