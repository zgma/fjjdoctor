...
public class ImagePickerOption implements Serializable {
    ...
    private ArrayList<GLImage> selectedImages;
    private int showPrePosition = -1;
    ...
    public ImagePickerOption setSelectedImages(ArrayList<GLImage> images) {
        this.selectedImages = images;
        this.showPrePosition = -1;
        return this;
    }

    public int getShowPrePosition() {
        return showPrePosition;
    }

    public ImagePickerOption setShowPrePosition(int showPrePosition) {
        this.showPrePosition = showPrePosition;
        return this;
    }
